...
# Given transit_times, print a CSV table with the following columns: midtime, min(amount of ingress times, amount of egress times), 0.000; the column names are:
# N transit, t0 [BJD], sigma t0 [d]. Dont save it, just print it
print('N transit, t0 [BJD], sigma t0 [d]')
for midtime, times in transit_times.items():
    n_transit = max(len(times['ingress_times']), len(times['egress_times']))
    print(f'{n_transit}, {midtime}, 0.000')
...
# N_transit,t0,sigma_t0
# 1,336.4158128791701,0.0019768852404810997
# 2,428.90741928170985,0.0023101877311829
# 3,521.3990157413659,0.00215576782910745
# 4,613.8906075509657,0.0037682825852606
# 6,798.8737988732507,0.0015629754371861999
# 9,1076.3485972557396,0.00113741301184935
# 10,1168.8401910245566,0.0008988321194941
# 12,1353.8233881245326,0.00088223156574625
# 13,1446.3149835840013,0.0045108672117186
# 14,1538.8065771936788,0.0019899126272656
# 17,1816.281369130129,0.00285265956341605
# 18,1908.772975927818,0.0025759658001512
# 20,2093.756166039521,0.0014701241215540001
# 22,2278.7393530091585,0.00420507140193875
